...
import com.fireworks.myeventsdk.Utils.CommonInterface.checkEmailSSOLoginCallback
import com.fireworks.myeventsdk.Utils.CommonInterface.getCognitoUserCallback
...
//                            AppUtil.applicationToken = loginResponse.token ?: ""
    ...
    @RequiresPermission(Manifest.permission.ACCESS_NETWORK_STATE)
    fun checkEmailLoginSSO(
        context: Context,
        email: String,
        extraParams: Map<String, String> = emptyMap(), // <-- optional dynamic fields
        callback: checkEmailSSOLoginCallback
    ) {
        appPreference = AppPreference.getInstance(context)
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                val response = retrofitService.checkEmailLoginSSO(fields)
    ...
    fun sendEmailOtpSSO(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                val response = retrofitService.sendEmailOtpSSO(fields)
    ...
    fun loginEmailSSO(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                val response = retrofitService.loginEmailSSO(fields)
    ...
    fun registerEmailOtpV4(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                val response = retrofitService.registerEmailOtpV4(fields)
    ...
    @RequiresPermission(Manifest.permission.ACCESS_NETWORK_STATE)
    fun checkCognitoEmail(
        context: Context,
        email: String,
        extraParams: Map<String, String> = emptyMap(), // <-- optional dynamic fields
        callback: CommonInterface.checkCognitoEmail
    ) {
        appPreference = AppPreference.getInstance(context)
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                val response = retrofitService.checkCognitoEmail(fields)
    ...
    fun registerEmailOtpVerifyV4(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                val response = retrofitService.registerEmailOtpVerifyV4(fields)
  ...
  @RequiresPermission(Manifest.permission.ACCESS_NETWORK_STATE)
    fun getCognitoUser(
        ...
        email: String,
        extraParams: Map<String, String> = emptyMap(), // <-- optional dynamic fields
        callback: getCognitoUserCallback
    ) {
        appPreference = AppPreference.getInstance(context)
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                val response = retrofitService.getCognitoUser(fields)

                withContext(Dispatchers.Main) {
                    if (response.isSuccessful && response.body() != null) {
                        val loginResponse = response.body()!!
                        Log.d("SSOUserInfo", "Login successful: $loginResponse")
                        callback.onSuccess(loginResponse)
                    } else {
                        callback.onFailure("Login failed with status: ${response.code()}")
                    }
